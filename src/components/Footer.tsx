      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-gray-700 dark:text-gray-300 max-w-md">
              A Fullstack Developer passionate about creating impactful digital experiences 
              through elegant design, robust code, and cutting-edge innovation.
            </p>
            <div className="mt-6 flex space-x-4">
              <a 
                ...
                className="p-2 rounded-full text-gray-700 hover:text-blue-600 hover:bg-gray-200 dark:text-gray-300 dark:hover:text-blue-400 dark:hover:bg-gray-700 transition-colors duration-200"
                aria-label="GitHub"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a 
                  href="mailto:contact@fauzanardian.com" 
                  className="text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400 transition-colors duration-200"
                >
                  contact@fauzanardian.com
                </a>
              </li>
              <li>
                <a 
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 text-center">
          <p className="text-gray-700 dark:text-gray-300">
            © {currentYear} Fauzan Ardian. All rights reserved.
          </p>
